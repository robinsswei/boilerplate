...
var banner = ['/*!\n',
  ' * Single Page Web Application Boilerplate - <%= pkg.title %> v<%= pkg.version %> (<%= pkg.homepage %>)\n',
  ' * Copyright 2018 <%= pkg.author %>\n',
  ' * Licensed under <%= pkg.license %> (https://github.com/robinsswei/<%= pkg.name %>/blob/master/LICENSE)\n',
  ' */\n',
  ''
].join('');
...
gulp.task('copy', function() {
  ...
  gulp.src(['node_modules/underscore/underscore.js', 'node_modules/underscore/underscore-min.js'])
